            ...
            <ul className="nav flex-column">
                ...
                <li className="nav-item">
                    <a className="nav-link text-light"
                        ...
                        href="#submenuDespesas"
                        role="button"
                        aria-expanded="false"
                        aria-controls="submenuDespesas">

                        💸 Despesas
                    </a>

                    <ul id="submenuDespesas" className="collapse list-unstyled ms-3">
                        <li>
                            <Link to="./despesas" className="nav-link text-light">
                                Lista
                            </Link>
                        </li>
                    </ul>
                ...
                <li>
                    <a className="nav-link text-light"
                        data-bs-toggle="collapse"
                        href="#submenuTransacoes"
                        role="button"
                        aria-expanded="false"
                        aria-controls="submenuTransacoes">

                        Transações
                    </a>

                    <ul id="submenuTransacoes" className="collapse list-unstyled ms-3">
                        <li>
                            <Link to="./transacoes" className="nav-link text-light">
                                Lista
                            </Link>
                        </li>
                        <li>
